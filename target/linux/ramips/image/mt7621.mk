...
define Device/asus_rt-ac65p
  ...
  IMAGE/factory.bin := append-kernel | pad-to $$(KERNEL_SIZE) | append-ubi | \
	check-size
  DEVICE_PACKAGES := kmod-usb3 kmod-mt7615e mt7615-firmware uboot-envtools
endef
...
define Device/dlink_dir-xx60-a1
  ...
  UBINIZE_OPTS := -E 5
  DEVICE_VENDOR := D-Link
  DEVICE_PACKAGES := kmod-mt7615e mt7615-firmware kmod-usb3 \
	kmod-usb-ledtrig-usbport
...
define Device/wavlink_wl-wn531a6
  ...
  DEVICE_PACKAGES := kmod-mt7603 kmod-mt7615e mt7615-firmware kmod-usb3
  IMAGE_SIZE := 15040k
endef
